...
var options = [
  ...
  opt('excludeSubkeys', 'array of keys or patterns (with *) to exlude from browsing', parseHson),
  opt('logKeysContinuously', 'log keys on the console "on the fly" (may help understand slow command calls)', function(val) {return val == 'true';})
];
